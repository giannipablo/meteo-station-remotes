...
////////////////////////////////////////////////////////////////////////////////
void WF::init(SMEM msmem){
  int i = 0;
  WiFi.mode(WIFI_STA);
  sprintf(ssid_str,"%s", msmem.readFile(SPIFFS, "/SSID.txt").c_str());
  sprintf(pass_str,"%s", msmem.readFile(SPIFFS, "/PASS.txt").c_str());
  sprintf(host_str,"%s", msmem.readFile(SPIFFS, "/HOST.txt").c_str());
  sprintf(endp_str,"%s", msmem.readFile(SPIFFS, "/ENDPOINT.txt").c_str());
